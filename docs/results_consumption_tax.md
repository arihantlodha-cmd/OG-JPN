...
The magnitudes are indicative, not final. This is a comparison of two steady states, which is robust to the level miss in K/Y and C/Y (see docs/METHODOLOGY.md) because both sides carry the same miss, but the tax side is still first-pass, so the honest reading is the direction and rough size, not the last digit.
